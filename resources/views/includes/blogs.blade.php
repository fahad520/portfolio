                ...
                <div class="single-cat-widget">
                    <div class="content relative">
                        ...
                        <a href="{{route('single')}}" target="_blank">
                            <div class="thumb">
                                <img class="content-image img-fluid d-block mx-auto" src="{{asset('assets/img/blog/cat-widget1.jpg')}}" alt="">
                            </div>
                ...
                <div class="single-cat-widget">
                    <div class="content relative">
                        ...
                        <a href="#" target="_blank">
                            <div class="thumb">
                                <img class="content-image img-fluid d-block mx-auto" src="{{asset('assets/img/blog/cat-widget2.jpg')}}" alt="">
                            </div>
                            <div class="content-details">
            ...
            <div class="col-lg-4">
                <div class="single-cat-widget">
                    <div class="content relative">
                        ...
                        <a href="#" target="_blank">
                            <div class="thumb">
                                <img class="content-image img-fluid d-block mx-auto" src="{{asset('assets/img/blog/cat-widget3.jpg')}}" alt="">
                            </div>
                            <div class="content-details">
        ...
        <div class="row">
            <div class="col-lg-8 posts-list">
                <div class="single-post row">
                    ...
                    <div class="col-lg-9 col-md-9 ">
                        <div class="feature-img">
                            <img class="img-fluid" src="{{asset('assets/img/blog/feature-img1.jpg')}}" alt="">
                        </div>
                ...
                <div class="single-post row">
                    ...
                    <div class="col-lg-9 col-md-9 ">
                        <div class="feature-img">
                            <img class="img-fluid" src="{{asset('assets/img/blog/feature-img2.jpg')}}" alt="">
                        </div>
                ...
                <div class="single-post row">
                    ...
                    <div class="col-lg-9 col-md-9">
                        <div class="feature-img">
                            <img class="img-fluid" src="{{asset('assets/img/blog/feature-img3.jpg')}}" alt="">
                        </div>
                ...
                <div class="single-post row">
                    ...
                    <div class="col-lg-9 col-md-9">
                        <div class="feature-img">
                            <img class="img-fluid" src="{{asset('assets/img/blog/feature-img4.jpg')}}" alt="">
                        </div>
                ...
                <div class="single-post row">
                    ...
                    <div class="col-lg-9 col-md-9">
                        <div class="feature-img">
                            <img class="img-fluid" src="{{asset('assets/img/blog/feature-img5.jpg')}}" alt="">
                        </div>
            ...
            <div class="col-lg-4 sidebar-widgets">
                <div class="widget-wrap">
                    ...
                    <div class="single-sidebar-widget ads-widget">
                        <a href="#"><img class="img-fluid" src="{{asset('assets/img/blog/ads-banner.jpg')}}" alt=""></a>
                    </div>
